...
const Courses=()=>{
    ...
    <Helmet><title>{title}</title></Helmet>
          <div class="py-8 py-md-11" style={{backgroundimage: 'none'}}>
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Courses Grid 01</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-scroll justify-content-center">
                    <li class="breadcrumb-item">
                        <NavLink class="text-gray-800" to="/">
                            Home
                        </NavLink>
                    </li>
    ...
    <div class="container pb-4 pb-xl-7">
        <div class="row row-cols-md-2 row-cols-xl-3 mb-6 mb-xl-3">
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <a href="course-single-v2.html"><span class="mb-1 d-inline-block text-gray-800">Development</span></a>

                        
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete JavaScript Course 2020: Build Real Projects!</h4></a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete Financial Analyst Course 2020</h4></a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Unity Medical Visualization: 03 Deployment and Usability</h4></a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Cubase Pro 10 Essential Training: Advanced</h4></a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="course-single-v2.html" class="card-img sk-thumbnail d-block">
                            <img class="rounded shadow-light-lg" src="assets/img/products/product-22.jpg" alt="..."/>
                        </a>
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">QuickBooks Online Essential Training </h4></a>
        ...
        <div class="text-center">
            <a class="btn btn-outline-white mw-300p d-flex mx-auto read-more" data-bs-toggle="collapse" href="#loadcollapseExample" role="button" aria-expanded="false" aria-controls="loadcollapseExample">
