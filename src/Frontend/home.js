...
const Home=()=>{
    ...
    return(<>
     <Helmet><title>{title}</title></Helmet>
       <section className="py-4 py-md-13 position-relative bg-white">
        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-12 col-md-5 col-lg-6 order-md-2" data-aos="fade-in" data-aos-delay="50">

   
                    <img src="assets/img/illustrations/illustration-1.png" className="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..."/>

                </div>
                <div className="col-12 col-md-7 col-lg-6 order-md-1 px-md-0">
                  
                    <h1 className="display-2" data-aos="fade-left" data-aos-duration="150">
                        Learn From <span className="text-orange fw-bold">Anywhere</span>
                    </h1>

                    <p className="lead pe-md-8 text-capitalize" data-aos="fade-up" data-aos-duration="200">
                        Technology is bringing a massive wave of evolution on learning things in different ways.
                    </p>

                    
                    <a href="course-list-v1.html" className="btn btn-wide btn-slide slide-primary shadow mb-4 mb-md-0 me-md-5" data-aos-duration="200" data-aos="fade-up">GET STARTED</a>
                    <a href="course-list-v1.html" className="btn btn-primary btn-wide lift d-none d-lg-inline-block" data-aos-duration="200" data-aos="fade-up">VIEW COURSES</a>
        ...
        <div className="container">
            <div className="row align-items-center mb-5" data-aos="fade-up">
                ...
                <div className="col-md-auto">
                    <select className="form-select form-select-sm text-primary fw-medium shadow" data-choices>
            ...
            <div className="mx-n4" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                <div className="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="50" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                    ...
                    <div className="card border shadow p-2 sk-fade">
                        ...
                        <div className="card-zoom position-relative">
                            <div className="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="course-single-v1.html" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                ...
                                <a href="course-single-v1.html" className="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                            ...
                            <a href="course-single-v1.html" className="card-img sk-thumbnail d-block">
                        ...
                        <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <a href="course-single-v1.html"><span className="mb-1 d-inline-block text-gray-800">Photography</span></a>


                           
                            <div className="position-relative">
                                <a href="course-single-v1.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Fashion Photography From Professional</h4></a>
                ...
                <div className="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="100" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                    ...
                    <div className="card border shadow p-2 sk-fade">
                        ...
                        <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <a href="course-single-v1.html"><span className="mb-1 d-inline-block text-gray-800">Development</span></a>

                          
                            <div className="position-relative">
                                <a href="course-single-v1.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete JavaScript Course 2020: Build Real Projects!</h4></a>
                ...
                <div className="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="150" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                    ...
                    <div className="card border shadow p-2 sk-fade">
                        ...
                        <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div className="position-relative">
                                <a href="course-single-v1.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma: User Interface Design Essentials - UI/UX Design</h4></a>
                ...
                <div className="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="200" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                    ...
                    <div className="card border shadow p-2 sk-fade">
                        ...
                        <div className="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div className="position-relative">
                                <a href="course-single-v1.html" className="d-block stretched-link"><h4 className="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">The Complete Financial Analyst Course 2020</h4></a>
                                ...
                                <div className="row mx-n2 align-items-end mh-50">
                                    <div className="col px-2">
                                        <ul className="nav mx-n3">
                                            ...
                                            <li className="nav-item px-3">
                                                <div className="d-flex align-items-center">
                                                    <div className="me-2 d-flex text-secondary">
    ...
    <section className="py-5 py-md-11 bg-white">
        <div className="container">
            <div className="row align-items-end mb-md-7 mb-4" data-aos="fade-up">
                ...
                <div className="col-md-auto">
                    <a href="course-list-v3.html" className="d-flex align-items-center fw-medium">
                        Browse All
            ...
            <div className="row row-cols-2 row-cols-lg-3 row-cols-xl-4">
                <div className="col mb-md-6 mb-4 px-2 px-md-4" data-aos="fade-up" data-aos-delay="50">
                    ...
                    <a href="course-list-v3.html" className="card icon-category border shadow-dark p-md-5 p-3 text-center lift">
    ...
    <section className="pt-5 pt-md-11 pb-9">
        <div className="container">
            ...
            <div className="mx-n4" data-flickity='{"pageDots": true, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                <div className="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="50" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                ...
                <div className="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="100" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                ...
                <div className="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="150" style={{paddingRight:'15px',paddingLeft:'15px'}}>
                ...
                <div className="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="200" style={{paddingRight:'15px',paddingLeft:'15px'}}>
    ...
    <div className="py-2 pt-md-5 pb-md-10">
        <div className="container">
            <div className="row row-cols-3 row-cols-md-5 text-center w-xl-80 mx-xl-auto justify-content-center align-items-center" data-aos="fade-up">
                <div className="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="50">
                ...
                <div className="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    <div className="mw-100p mx-auto">
                ...
                <div className="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="150">
                    <div className="mw-100p mx-auto">
                ...
                <div className="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div className="mw-100p mx-auto">
                ...
                <div className="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="250">
                    <div className="mw-100p mx-auto">
    ...
    <section className="bg-white py-5 pt-md-11 pb-md-10">
        <div className="container">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth:'120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-1.jpg" alt="..."/>
                            </a>

                           
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    <div className="badge badge-lg badge-orange badge-pill mb-3 mt-1 px-5 py-2">
                                        <span className="text-white font-size-sm fw-normal">06 Aprıl</span>
                                    </div>

                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">Elegant Light Box Paper Cut Dioramas New Design Conference</h5></a>
                ...
                <div className="col-lg mb-5 mb-md-6">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth:'120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-2.jpg" alt="..."/>
                            </a>
                            ...
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">Lambeth Safeguarding: Understanding Contextual Harm</h5></a>
                ...
                <div className="col-lg mb-5 mb-md-6">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-3.jpg" alt="..."/>
                            </a>
                            ...
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">Discover Law - Get into the best UK law schools</h5></a>
                ...
                <div className="col-lg mb-5 mb-md-6">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-4.jpg" alt="..."/>
                            </a>
                            ...
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">Undergraduate Open Day – Holloway Campus - 3 July 2020</h5></a>
                ...
                <div className="col-lg mb-5 mb-md-6">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-5.jpg" alt="..."/>
                            </a>
                            ...
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">"Introduction to Law" Open Day with Bristows</h5></a>
                ...
                <div className="col-lg mb-5 mb-md-6">
                    ...
                    <div className="card border shadow p-2 lift">
                        <div className="row gx-0">
                            ...
                            <a href="event-single.html" className="col-auto d-block mw-md-152" style={{maxWidth: '120px'}}>
                                <img className="img-fluid rounded shadow-light-lg h-100 o-f-c" src="assets/img/events/event-6.jpg" alt="..."/>
                            </a>
                            ...
                            <div className="col">
                                <div className="card-body py-0 px-md-5 px-3">
                                    ...
                                    <a href="event-single.html" className="d-block mb-2"><h5 className="line-clamp-2 h-xl-52 mb-1">Kingston College undergraduate Open Events 2019-20</h5></a>
    ...
    <section className="py-5 py-md-11">
        <div className="container">
            <div className="row align-items-end mb-3 mb-md-5" data-aos="fade-up">
                <div className="col-md mb-4 mb-md-0">
                    <h1 className="mb-1">Top Rating Instructors</h1>
                    <p className="font-size-lg mb-0 text-capitalize">Discover your perfect program in our courses.</p>
                </div>
                <div className="col-md-auto">
                    <a href="instructors-list-v1.html" className="d-flex align-items-center fw-medium">
                        Browse All
                        <div className="ms-2 d-flex">
            ...
            <div className="mx-n3 mx-md-n4" data-flickity='{"pageDots": false,"cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                <div className="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="50">
                    <div className="card border shadow p-2 lift">
                      
                        <div className="card-zoom position-relative" style={{maxWidth: '250px'}}>
                            <div className="card-float card-hover right-0 left-0 bottom-0 mb-4">
                                <ul className="nav mx-n4 justify-content-center">
                            ...
                            <a href="instructors-single.html" className="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img className="rounded shadow-light-lg img-fluid" src="assets/img/instructors/instructor-1.jpg" alt="..."/></a>
                        </div>

                       
                        <div className="card-footer px-3 pt-4 pb-1">
                            <a href="instructors-single.html" className="d-block"><h5 className="mb-0">Jack Wilson</h5></a>
                            <span className="font-size-d-sm">Developer</span>
                        </div>
                    </div>
                </div>
                <div className="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div className="card border shadow p-2 lift">
                        ...
                        <div className="card-zoom position-relative" style={{maxWidth: '250px'}}>
                            ...
                            <a href="instructors-single.html" className="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img className="rounded shadow-light-lg img-fluid" src="assets/img/instructors/instructor-2.jpg" alt="..."/></a>
                        </div>

                       
                        <div className="card-footer px-3 pt-4 pb-1">
                            <a href="instructors-single.html" className="d-block"><h5 className="mb-0">Anna Richard</h5></a>
                            <span className="font-size-d-sm">Travel Bloger</span>
                        </div>
                    </div>
                </div>
                <div className="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="150">
                    <div className="card border shadow p-2 lift">
                        ...
                        <div className="card-zoom position-relative" style={{maxWidth: '250px'}}>
                            ...
                            <a href="instructors-single.html" className="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img className="rounded shadow-light-lg img-fluid" src="assets/img/instructors/instructor-3.jpg" alt="..."/></a>
                        </div>

                       
                        <div className="card-footer px-3 pt-4 pb-1">
                            <a href="instructors-single.html" className="d-block"><h5 className="mb-0">Kathelen Monero</h5></a>
                            <span className="font-size-d-sm">Designer</span>
                        </div>
                    </div>
                </div>
                <div className="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div className="card border shadow p-2 lift">
                        ...
                        <div className="card-zoom position-relative" style={{maxWidth: '250px'}}>
                            ...
                            <a href="instructors-single.html" className="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img className="rounded shadow-light-lg img-fluid" src="assets/img/instructors/instructor-4.jpg" alt="..."/></a>
                        </div>

                       
                        <div className="card-footer px-3 pt-4 pb-1">
                            <a href="instructors-single.html" className="d-block"><h5 className="mb-0">Kristen Pala</h5></a>
                            <span className="font-size-d-sm">User Experience Design</span>
                        </div>
                    </div>
                </div>
                <div className="col-6 col-md-4 col-lg-3 text-center py-5 text-md-left px-3 px-md-4" data-aos="fade-up" data-aos-delay="250">
                    <div className="card border shadow p-2 lift">
    ...
    <section className="bg-white py-5 py-md-11">
        <div className="container">
            <div className="row align-items-end mb-4 mb-md-7" data-aos="fade-up">
                ...
                <div className="col-md-auto">
                    <a href="blog-grid-v1.html" className="d-flex align-items-center fw-medium">
                        Browse All
                        <div className="ms-2 d-flex">
            ...
            <div className="row row-cols-md-2 row-cols-lg-3">
                <div className="col-md mb-5 mb-lg-0">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                        ...
                        <div className="card-zoom position-relative">
                            <a href="blog-single.html" className="card-img d-block sk-thumbnail img-ratio-3"><img className="rounded shadow-light-lg img-fluid" src="assets/img/post/post-1.jpg" alt="..."/></a>

                            <a href="blog-single.html" className="badge sk-fade-bottom badge-lg badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                        ...
                        <div className="card-footer px-2 pb-0 pt-4">
                            <ul className="nav mx-n3 mb-3">
                                <li className="nav-item px-3">
                                    <a href="blog-single.html" className="d-flex align-items-center text-gray-800">
                            ...
                            <a href="blog-single.html" className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the World Trip</h5></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md mb-5 mb-lg-0">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                        ...
                        <div className="card-zoom position-relative">
                            <a href="blog-single.html" className="card-img d-block sk-thumbnail img-ratio-3"><img className="rounded shadow-light-lg img-fluid" src="assets/img/post/post-2.jpg" alt="..."/></a>
                        ...
                        <div className="card-footer px-2 pb-0 pt-4">
                            ...
                            <a href="blog-single.html" className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From 3500 Years Ago</h5></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md mb-5 mb-lg-0">
                    ...
                    <div className="card border shadow p-2 lift sk-fade">
                        ...
                        <div className="card-zoom position-relative">
                            <a href="blog-single.html" className="card-img d-block sk-thumbnail img-ratio-3"><img className="rounded shadow-light-lg img-fluid" src="assets/img/post/post-3.jpg" alt="..."/></a>

                            <a href="blog-single.html" className="badge badge-lg sk-fade-bottom badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                        ...
                        <div className="card-footer px-2 pb-0 pt-4">
                            ...
                            <a href="blog-single.html" className="d-block"><h5 className="line-clamp-2 h-48 h-lg-52">10 Best Countries to Visit for Beginner Travelers</h5></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section className="py-6 py-md-11 border-top border-bottom jarallax" data-jarallax data-speed=".8" style={{backgroundImage: 'url(assets/img/illustrations/illustration-1.jpg)'}}>
        <div className="container text-center py-xl-4" data-aos="fade-up">
            <h1 className="text-capitalize">Get personal learning recommendations</h1>
            <div className="font-size-lg mb-md-6 mb-4">Enhance your skills with best Online courses</div>
            <div className="mx-auto">
                <a href="course-list-v1.html" className="btn btn-primary btn-x-wide lift d-inline-block">GET STARTED NOW</a>
            </div>
        </div>
    </section>
    </>)
