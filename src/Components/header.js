...
const Header=()=>{
    ...
    <div className="modal modal-sidebar left fade-left fade" id="cartModal">
        ...
        <div className="container-fluid">
                        ...
                        <li className="dropdown-item dropright">
                            ...
                            <div className="dropdown-menu ps-3 top-0 pe-0 py-0 shadow-none bg-transparent">
                                <div className="dropdown-menu-md bg-primary rounded dropdown-menu-inner">
                                    <a className="dropdown-item" href="course-single-v1.html">
                                        All Business
                                    </a>
                                    <a className="dropdown-item" href="course-single-v2.html">
                                        Finance
                                    </a>
                                    <a className="dropdown-item" href="course-single-v3.html">
                                        Entrepreneurship
                                    </a>
                                    <a className="dropdown-item" href="course-single-v4.html">
                                        Communications
                                    </a>
                                    <a className="dropdown-item" href="course-single-v5.html">
                                        Management
                                    </a>
                                    <a className="dropdown-item" href="course-single-v1.html">
                                        Sales
                            ...
                            <a className="dropdown-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                <div className="me-4 d-flex text-white icon-xs">
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M18.2422 0.0397949H1.75781C0.788555 0.0397949 0 0.82835 0 1.79761V18.2039C0 19.1731 0.788555 19.9617 1.75781 19.9617H18.2422C19.2114 19.9617 20 19.1731 20 18.2039V1.79761C20 0.82835 19.2114 0.0397949 18.2422 0.0397949ZM1.75781 1.21167H18.2422C18.5653 1.21167 18.8281 1.47452 18.8281 1.79761V4.72729H1.17188V1.79761C1.17188 1.47452 1.43473 1.21167 1.75781 1.21167ZM18.2422 18.7898H1.75781C1.43473 18.7898 1.17188 18.5269 1.17188 18.2039V5.89917H18.8281V18.2039C18.8281 18.5269 18.5653 18.7898 18.2422 18.7898Z" fill="currentColor"></path>
                                        <path d="M11.9887 7.70365C11.6912 7.57619 11.3468 7.71396 11.2193 8.01138L7.70367 16.2145C7.57616 16.5119 7.71398 16.8564 8.0114 16.9839C8.30894 17.1114 8.65335 16.9735 8.78078 16.6761L12.2964 8.47302C12.4239 8.17556 12.2861 7.83111 11.9887 7.70365Z" fill="currentColor"></path>
                                        ...
                                        <path d="M16.8114 11.8863L13.8817 9.54251C13.629 9.34032 13.2602 9.38129 13.0581 9.63399C12.856 9.88668 12.8969 10.2554 13.1496 10.4575L15.5074 12.3438L13.1496 14.23C12.8969 14.4321 12.856 14.8009 13.0581 15.0536C13.2605 15.3065 13.6293 15.347 13.8817 15.145L16.8114 12.8013C17.1043 12.567 17.1045 12.1207 16.8114 11.8863Z" fill="currentColor"></path>
                                        <path d="M2.96875 3.55469C3.29235 3.55469 3.55469 3.29235 3.55469 2.96875C3.55469 2.64515 3.29235 2.38281 2.96875 2.38281C2.64515 2.38281 2.38281 2.64515 2.38281 2.96875C2.38281 3.29235 2.64515 3.55469 2.96875 3.55469Z" fill="currentColor"></path>
                                        <path d="M5.3125 3.55469C5.6361 3.55469 5.89844 3.29235 5.89844 2.96875C5.89844 2.64515 5.6361 2.38281 5.3125 2.38281C4.9889 2.38281 4.72656 2.64515 4.72656 2.96875C4.72656 3.29235 4.9889 3.55469 5.3125 3.55469Z" fill="currentColor"></path>
                                        <path d="M7.65625 3.55469C7.97985 3.55469 8.24219 3.29235 8.24219 2.96875C8.24219 2.64515 7.97985 2.38281 7.65625 2.38281C7.33265 2.38281 7.07031 2.64515 7.07031 2.96875C7.07031 3.29235 7.33265 3.55469 7.65625 3.55469Z" fill="currentColor"></path>
                                        <path d="M13.5156 3.55469H17.0312C17.3548 3.55469 17.6172 3.29234 17.6172 2.96875C17.6172 2.64516 17.3548 2.38281 17.0312 2.38281H13.5156C13.192 2.38281 12.9297 2.64516 12.9297 2.96875C12.9297 3.29234 13.192 3.55469 13.5156 3.55469Z" fill="currentColor"></path>
                                    </svg>
            ...
            <form className="d-none d-wd-flex ms-5 w-xl-450p">
                <div className="input-group border rounded">
                    <div className="input-group-prepend">
                        <button className="btn btn-sm my-2 my-sm-0 text-secondary icon-xs d-flex align-items-center" type="submit">
            ...
            <div className="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                ...
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" id="navbarBlog" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Blog
                        </a>
                        <ul className="dropdown-menu border-xl shadow-none" aria-labelledby="navbarBlog">
                            <li className="dropdown-item dropright">
                                <a className="dropdown-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                    Blog Grid
                                </a>
                                <div className="dropdown-menu border-xl shadow-none">
                            ...
                            <li className="dropdown-item dropright">
                                ...
                                <div className="dropdown-menu border-xl shadow-none">
                                    <a className="dropdown-item" href="blog-list-v1.html">
                                        List v1
                                    </a>
                                    <a className="dropdown-item" href="blog-list-v2.html">
                                        List v2
                                    </a>
                                </div>
                            </li>
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="blog-single.html">
                                    Blog Single
                                </a>
                            </li>
                        </ul>
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" id="navbarShop" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Shop
                        </a>
                        <ul className="dropdown-menu border-xl shadow-none" aria-labelledby="navbarShop">
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="shop-cart.html">
                                    Shop Cart
                                </a>
                            </li>
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="shop-checkout.html">
                                    Shop Checkout
                                </a>
                            </li>
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="shop-list.html">
                                    Shop List
                                </a>
                            </li>
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="shop-single.html">
                                    Shop Single
                                </a>
                            </li>
                            <li className="dropdown-item">
                                <a className="dropdown-link" href="shop-order-completed.html">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu border-xl shadow-none dropdown-menu-md" aria-labelledby="navbarDocumentation">
                            <div className="list-group list-group-flush">
                                <a className="list-group-item" href="docs/index.html">
                                    ...
                                    <div className="ms-4">
                                        ...
                                        <h5 className="text-primary mb-n1">
                                            Documentation
                                        </h5>
                                ...
                                <a className="list-group-item" href="docs/changelog.html">
                                    ...
                                    <span className="badge badge-pill badge-primary-soft ms-auto">
                                        1.0
                                    </span>
            ...
            <ul className="navbar-nav flex-row ms-auto ms-xl-0 me-n2 me-md-n4">
                ...
                <li className="nav-item border-0 px-0">
                    ...
                    <a href="#" className="nav-link d-flex px-3 px-md-4 position-relative text-secondary icon-xs" data-bs-toggle="modal" data-bs-target="#cartModal">
