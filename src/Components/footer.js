                    ...
                    <div className="border-top pb-5 pt-6 py-md-4 text-center text-xl-start d-flex flex-column d-md-block d-xl-flex flex-xl-row align-items-center">
                        ...
                        <div className="ms-xl-auto d-flex flex-column flex-md-row align-items-stretch align-items-md-center justify-content-center">
                            ...
                            <div className="choices" data-type="select-one" tabIndex="0" role="listbox" aria-haspopup="true" aria-expanded="false">
                                <div className="form-select form-select-sm font-size-sm-alone shadow min-width-140 text-left mb-4 mb-md-0">
                                    <select className="form-select form-select-sm font-size-sm-alone shadow min-width-140 text-left mb-4 mb-md-0 choices__input" data-choices="" hidden="" tabIndex="-1" data-choice="active">
